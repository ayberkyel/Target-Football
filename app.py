...
# CSS: Futbol Sahası, Seken Toplar ve Modern Tema
st.markdown("""
<style>
    ...
    /* --- VEKTÖREL FUTBOL SAHASI ARKA PLANI --- */
    .pitch-container {
        position: fixed;
        top: 5vh;
        left: 50%;
